...
class V10_Fat(Agent):
    ...
    def act(self, observation, reward, terminated, truncated, info):
        ...
        early_cost_target = 2  # 前 400 手，每把允許吃 0.85 秒
        late_cost_target = 0.3   # 後 600 手，每把只給 0.15 秒 (因為有很多局會直接 Fold，0.15 很夠)
        ...
        if current_hand <= 400:
            ...
            # 前期：較高的基礎模擬次數
            base_n_sim = {0: 200, 1: 300, 2: 400, 3: 500}.get(street, 200)
        else:
            early_hands_left = 0
            late_hands_left = self.total_hands - current_hand + 1
            
            # 中後期：保守的模擬次數
            base_n_sim = {0: 100, 1: 200, 2: 300, 3: 400}.get(street, 100)
